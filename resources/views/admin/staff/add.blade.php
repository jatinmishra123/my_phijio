...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Add Nurses</h4>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Add Nurse</h4>
            </div><!-- end card header -->
                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input class="form-control" type="text" name="phone" placeholder="Phone" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 10) ? null : event.charCode >= 48 && event.charCode <= 57" maxlength="10" minlength="10" required>
                                        ...
                                        <!--    <input type="file" class="form-control" id="validationCustom02" name="image" accept="image/*" required>-->
                                        <!--</div>-->
                                    </div>
