        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{$role}} Master</a></li>
...
<div class="row">
    ...
    <div class="card-body">
        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
            ...
            <tbody>
                @php if(!empty($doctors)) { $i =0; foreach($doctors as $value) { @endphp
                <tr>
                    <td>{{ ++$i }} </td>
                    <td>{{$value->unique_id ?? '' }}</td>
                    <td><a href="{{ url('admin/doctors/profile/'.$value->doctor_id)}}">{{$value->name}}</a></td>
                    <td>{{$value->phone}}</td>
                    <td>{{$value->email}}</td>
                    <!--<td>{{$value->website ?? '' }}</td>-->
                    <td>
                        ...
                        <img src="{{ $value->image }}" style="width:80px">
                        @else
                        <img src="{{ asset('uploads/doctor/' . $value->image) }}" style="width:80px">
                        @endif
                    ...
                    <td> <a href="{{ url('admin/doctors/allotchamber/'.$value->doctor_id)}}" class="btn btn-danger">View Availibility / Bookings</a> </td>
                    ...
                    <td>
                        <button class="btn btn-sm btn-success" data-bs-target="#change_password" data-bs-toggle="modal" onclick="showchangepasswordpopup('{{ $value->doctor_id }}', 'user_table')"><i class="ri-key-fill"></i></button>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item edit-item-btn" href="{{ url('admin/doctors/edit/'.$value->ID)}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
